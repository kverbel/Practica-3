...
class ParrillaAdapter extends RecyclerView.Adapter<ParrillaAdapter.ParrillaViewHolder> {
    private List<Producto> items;

    public static class ParrillaViewHolder extends RecyclerView.ViewHolder {
        ...
        public ParrillaViewHolder(View v) {
            super(v);
    ...
    public ParrillaAdapter(List<Producto> items) {
        this.items = items;
    }
    ...
    @Override
    public ParrillaViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.productos_card, viewGroup, false);
        return new ParrillaViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ParrillaViewHolder viewHolder, int i) {
...
public class ParrillaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflated = inflater.inflate(R.layout.fragment_parrilla, container, false);
        ...
        final Cursor c = dbProductos.rawQuery("select * from Productos where idProducto like 'P%'", null);
        ...
        // Obtener el Recycler
        recycler = (RecyclerView) inflated.findViewById(R.id.recicladorPar);
        ...
        adapter = new ParrillaAdapter(items);
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(this.getActivity(), recycler, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                Toast.makeText(getActivity().getApplicationContext(), "Parrilla "+(position+1), Toast.LENGTH_SHORT).show();
            }
        }));
    ...
    class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private ParrillaFragment.ClickListener clicklistener;
        private GestureDetector gestureDetector;

        public RecyclerTouchListener(Context context, final RecyclerView recycleView, final ParrillaFragment.ClickListener clicklistener){
